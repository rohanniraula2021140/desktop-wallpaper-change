...
def draw_text_with_border_and_shadow(draw, text, position, font, text_color, shadow_offset=2, shadow_color=(0, 0, 0), border_color=(255, 255, 255)):
    ...
    for x_offset in [-border_offset, 0, border_offset]:
        for y_offset in [-border_offset, 0, border_offset]:
            if x_offset == 0 and y_offset == 0: continue  # Skip the center
...
def create_image(quote, author):
    ...
    draw_text_with_border_and_shadow(draw, wrapped_text, (x, y), font, (255, 255, 255))  # White text for good contrast
